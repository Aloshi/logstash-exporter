...
func (collector *PipelineSubcollector) Collect(pipeStats *responses.SinglePipelineResponse, pipelineID string, ch chan<- prometheus.Metric, endpoint string) {
	...
	newIntMetric(collector.DeadLetterQueueMaxSizeInBytes, prometheus.CounterValue, deadLetterQueueStats.MaxQueueSizeInBytes)
	newIntMetric(collector.DeadLetterQueueSizeInBytes, prometheus.CounterValue, deadLetterQueueStats.QueueSizeInBytes)
